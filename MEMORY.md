...
- (2026-08-20) TentOS assistant visual-usability update is on `codex/improve-tentos-assistant-visual-usability`: compact one-screen phone layout, visible voice control beside the composer, four installation-neutral quick requests, new-chat reset, scan-friendly response lines, and clearer confirmation copy. The production frontend build passes; release version is staged as 1.4.3 pending review/deploy approval.
