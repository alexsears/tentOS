...
- (2026-08-19) TentOS sensor state and newly recorded history normalize temperatures to Celsius. Assistant history also converts legacy Fahrenheit rows (>50 using the established grow-tent heuristic), labels statistics with units, and reports Fahrenheit first with Celsius in parentheses.
